...
theme.fonts = {
	...
	hotkeys  = {
		...
		key   = "Iosevka Term Light 11", -- hotkeys helper key font (use monospace for align)
...
theme.desktop.color = {
	...
	gray  = theme.color.gray_desktop or "#008000",
...
theme.desktop.common.textbox = {
	font = { font = "prototype", size = 20, face = 0 }
}
...
theme.service.navigator = {
	...
	color        = { border = theme.color.main, mark = theme.color.redflat, text = theme.color.wibox,
...
theme.gauge.task.blue = {
	...
	show_min = true,
	font     = theme.cairo_fonts.tag,
	point    = { width = 140, height = 3, gap = 27, dx = 5 },
	text_gap = 20,
	color    = theme.color
}
...
------------------------------------------------------------
theme.float.qlaunch = {
	geometry      = { width = 1200, height = 170 },
