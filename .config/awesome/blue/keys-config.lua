...
function hotkeys:init(args)
	...
	local layout_tile = {
		...
		{
			{ env.mod, "Shift"}, "+", function () awful.tag.incnmaster( 1, nil, true) end,
			{ description = "Increase the number of master clients", group = "Layout" }
		},
		{
			{ env.mod, "Shift" }, "_", function () awful.tag.incnmaster(-1, nil, true) end,
	...
	self.raw.root = {
		...
		-- },
		{
			{ env.mod }, "Tab", function() awful.client.focus.byidx(1) end, 
			{ description = "next windows", group = "Client focus" }
		},
    	{
			{ env.mod, "Shift"   }, "Tab", function() awful.client.focus.byidx(-1) end, 
			{ description = "prev windows", group = "Client focus" }
		},

		{
			{ env.mod, "Control" }, "n", restore_all,
		...
		{
			{ env.mod }, "Page_Down", awful.tag.viewnext,
			{ description = "View next tag", group = "Tag navigation" }
		},
		{
			{ env.mod }, "Page_Up", awful.tag.viewprev,
    	...
    	{
			{ env.mod, "Shift"   }, "Left", function () awful.client.swap.bydirection("left") end, 
			{description = "swap with left client", group = "client"}
		},
    	{
			{ env.mod, "Shift"   }, "Up", function () awful.client.swap.bydirection("up") end,
			{description = "swap with up client", group = "client"}
		},
    	{
			{ env.mod, "Shift"   }, "Down", function () awful.client.swap.bydirection("down") end,
